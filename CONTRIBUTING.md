...
posted to #DoubloonCoins-dev on irc.freenode.net).
...
The "DoubloonCoins Maintainer Team" is defined in this document as the following users:
- Doubloons
- spicedr
...
- Users MUST NOT log feature requests, ideas, or suggestions unrelated to DoubloonCoins code or DoubloonCoins's dependency code or DoubloonCoins's potential/future dependency code or research which successfully implements DoubloonCoins.
...
- Maintainers SHOULD NOT merge their own patches except in exceptional cases, such as non-responsiveness from other Maintainers for an extended period (more than 30 days) or unless urgent as defined by the DoubloonCoins Maintainers Team.
...
- Maintainers MUST NOT merge pull requests in less than 168 hours (1 week) unless deemed urgent by at least 2 people from the DoubloonCoins Maintainer Team.
